            ...
            <div>
                ...
                <div class="grid inner_spacing">
                    ...
                    <div>
                        <p><b>PRAKTISK</b></p>
                        <ul>
                            <li>Infobreve o  opholdet inden afrejse (med bl.a. pakkeliste, rejsetips, praktisk, etc.)</li>
            ...
            <div class="lg:col-start-1">
                ...
                <div class="grid inner_spacing">
                    ...
                    <div>
                        ...
                        <ul>
                            <li>Tidligere elever har samlet brugt ca. 30.000 DKK til 40.000 DKK undervejs på opholdet.</li>
                        </ul>
                    </div>
                </div>
            </div>
