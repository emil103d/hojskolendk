<main class="col-start-2">
  ...
  <section class="lg:grid md:grid-cols-2 maxwidthwrapper">
   ...
   <div class="lg:col-start-2">
       <img class="h-auto object-cover w-full aspect-square"src="src/_images//webp/program_1.webp" alt="">
   </div>
 </section>
   ...
   <section class="maxwidthwrapper">
     ...
     <div>
        <div class="flex overflow-x-scroll pb-10 flex-nowrap overflow-hidden lg:overflow-auto">
            <div class="flex flex-nowrap gap-2 lg:gap-8 lg:grid lg:grid-cols-3">
                <img class="object-cover w-full aspect-square " src="src/_images//webp/program_2.webp" alt="">
                <img class="object-cover w-full aspect-square" src="src/_images//webp/program_3.webp" alt="">
                <img class="object-cover w-full aspect-square" src="src/_images//webp/program_4.webp" alt="">
            </div>
          </div>
    </div>
   </section>
    ...
    <!-- SECTION 4 -->
    <section class="lg:grid md:grid-cols-2 lg:grid-rows-1 maxwidthwrapper">
   ...
   <section class="maxwidthwrapper">
     ...
     <div>
         <div class="flex overflow-x-scroll pb-10 flex-nowrap overflow-hidden lg:overflow-auto">
             <div class="flex flex-nowrap gap-2 lg:gap-8 lg:grid lg:grid-cols-3">
                 <img class="object-cover w-full aspect-square" src="src/_images//webp/program_5.webp" alt="">
                 <img class="object-cover w-full aspect-square" src="src/_images//webp/program_6.webp" alt="">
                 <img class="object-cover w-full aspect-square" src="src/_images//webp/program_7.webp" alt="">
             </div>
           </div>
     </div>
   </section>
   ...
   <!-- SECTION 6 -->
   <section class="lg:grid lg:grid-cols-2 lg:grid-rows-1 maxwidthwrapper">
     ...
     <div class="lg:col-start-2 lg:row-start-1">
         <img class="object-cover w-full aspect-square" src="src/_images//webp/program_9.webp" alt="">
     </div>
 </section>
